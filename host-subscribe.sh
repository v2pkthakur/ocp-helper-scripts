...
subscription-manager repos --enable=rhel-7-server-rpms --enable=rhel-7-server-extras-rpms --enable=rhel-7-server-optional-rpms --enable=rhel-7-server-ose-3.11-rpms --enable=rhel-7-server-rh-common-rpms --enable=--enable=rh-gluster-3-for-rhel-7-server-rpms --enable=
